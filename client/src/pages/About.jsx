...
const About = () => {
  return (
    <>
      <div className="text-2xl text-center pt-10 text-gray-600 font-medium">
        <p>
      ...
      <div className="text-2xl text-center pt-10 text-gray-700 font-medium my-4">
        <p>
          Why To <span className="text-gray-700 font-bold">Choose Us?</span>
        </p>
      </div>
